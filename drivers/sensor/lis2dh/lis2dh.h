...
#define LIS2DH_EN_CLICK_INT2_SHIFT      7
#define LIS2DH_EN_CLICK_INT2            BIT(LIS2DH_EN_CLICK_INT2_SHIFT)
...
#define LIS2DH_REG_CLICK_TIME_LMT       0x3B
#define LIS2DH_REG_CLICK_TIME_LAT       0x3C
#define LIS2DH_REG_CLICK_TIME_WINDOW    0x3D
#define LIS2DH_SINGLE_CLICK_BIT         BIT(4)
#define LIS2DH_DOUBLE_CLICK_BIT         BIT(5)
#define LIS2DH_SINGLE_CLICK_EN          (BIT(4) | BIT(2) | BIT(0))
#define LIS2DH_DOUBLE_CLICK_EN          (BIT(5) | BIT(3) | BIT(1))
#define LIS2DH_SINGLE_DOUBLE_CLICK_EN	0x2F
#endif
